...
# ── Driver uscite progetto @ 0x40 — mapping interno verso uscite PLC ─────────
...
INPUT_PINS = {
    ...
    'FB_C2_NC': 12,               # SOSTITUISCI se I0.12 nel tuo layer ha mapping diverso
}

INPUT_DEBOUNCE_MS = 50

# Feedback relè C2 da contatto NC
# - relè C2 OFF -> contatto NC chiuso
# - relè C2 ON  -> contatto NC aperto
...
C2_DELTA_ON       = 5.0    # delta solare > delta_pdc + questa soglia -> ON
C2_DELTA_OFF      = 3.0    # delta solare > delta_pdc + questa soglia -> resta ON
C2_HARD_STOP_TEMP = 85.0   # S4 >= questo -> C2 OFF
